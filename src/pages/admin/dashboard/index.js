...
import { actionGetExport, actionGetImport, actionGetWarehouse } from 'store/reducers/warehouse';
  ...
  return (
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Total User" count={dataUser ? dataUser?.users?.length : 0} icon={<Inventory2Icon />} />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce
          title="Total Categories"
          count={dataCategory?.productCategories?.length || 0}
          isLoss
          icon={<ReceiptLongIcon />}
        />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Total Brand" icon={<FileUploadIcon />} count={dataBrand?.brands?.length || 0} isLoss />
      </Grid>
